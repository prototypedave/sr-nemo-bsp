...
public:
   ...
   */
  Mipv6Mn (std::list<Ipv6Address> haalist,bool RorH,Ipv6Address mnp, std::list<Ipv6Address> aralist);//adding last2 argument in constructor for NEMO
...
private:
  ...
  /**
    * \brief AR router address list
  */
  std::list<Ipv6Address> m_Aralist;
